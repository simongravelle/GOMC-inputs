...
def PDB_writer(filename, u, exchanged_molecule, empty_box=False):
    if empty_box:
        f = open(filename, "w")
        f.write("REMARK original generated coordinate pdb file\n")
        f.write("END\n")
        f.close()
    else:
...
def PSF_writer(filename, u, empty_box=False):
    ...
    if empty_box:
        ...
        f.write("       0 !NTITLE\n\n")
        f.write("       0 !NATOM\n\n")
        f.write("       0 !NBOND: bonds\n\n")
        f.write("       0 !NTHETA: angles\n\n")
